...
export default function PostCard({ post, colorClass }: PostCardProps) {
  return (
    <article
      ...
      class={`flex flex-col h-full w-full p-6 border-4 border-whalies-navy rounded-4xl ${colorClass} shadow-cartoon hover:translate-y-1 hover:translate-x-1 hover:shadow-cartoon-hover transition-[transform,box-shadow] duration-200 group`}
    >
      {/* Tags at the top */}
