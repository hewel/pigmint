  ...
  return (
    <>
      ...
      <Layout showBackButton>
        <div class="w-full px-2 sm:px-6 lg:px-8 py-6 md:py-12 mx-auto max-w-6xl xl:max-w-7xl relative">
          <article class="max-w-4xl mx-auto bg-white dark:bg-gray-800 border-4 border-whalies-navy dark:border-gray-500 rounded-4xl p-4 md:p-12 shadow-cartoon text-whalies-navy dark:text-gray-100">
